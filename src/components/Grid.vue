...
<template>
    <section id="grid">
        <button :disabled="workoutIdx > 0  && workoutIdx > firstInCompleteWorkoutIndex" @click="handleSelectWorkout(workoutIdx)" :key="workoutIdx" v-for="(_,workoutIdx) in Object.keys(workoutProgram)" class="card-button plan-card">
            <div>
